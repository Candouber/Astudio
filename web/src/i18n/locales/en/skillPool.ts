...
const en: TranslationTree = {
  skillPool: {
    ...
    assignModalAria: 'Skill assignment confirmation',
    assignModalDesc: 'Choose which employees should receive this Skill. After import or creation, all employees are selected by default:',
    loadingEmployees: 'Loading employees...',
    selectAll: 'Select all',
    unselectAll: 'Clear selection',
    selectedEmployees: '{{n}} / {{total}} employees selected',
    alreadyAssigned: 'Already has it',
    selectAtLeastOne: 'Select at least one employee',
    assignSelected: 'Assign to {{n}} employees',
    assignBulkSuccess: 'Assigned to {{n}} employees',
