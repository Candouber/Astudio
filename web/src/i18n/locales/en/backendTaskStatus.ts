...
const en: TranslationTree = {
  backendTaskStatus: {
    ...
    reuse_studio_leader_plan: 'Using team "{{name}}"; Leader is breaking down the task…',
    agent_zero_evaluating: 'Agent Zero is selecting the right team…',
    agent_zero_direct: 'Agent Zero is handling this directly…',
    answer_done: 'Answer complete',
    creating_new_studio: 'Preparing the team…',
    handed_to_studio_leader: 'Handed to "{{name}}"; Leader is breaking down the task…',
    recruiting_employee: 'Capability gap "{{role}}" found; planning with existing employees…',
