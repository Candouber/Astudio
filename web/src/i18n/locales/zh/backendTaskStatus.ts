...
const zh: TranslationTree = {
  backendTaskStatus: {
    ...
    reuse_studio_leader_plan: '沿用团队「{{name}}」，Leader 开始拆解任务…',
    agent_zero_evaluating: '0 号 Agent 正在选择合适团队…',
    agent_zero_direct: '0 号正在直接处理…',
    answer_done: '回答完毕',
    creating_new_studio: '正在准备团队…',
    handed_to_studio_leader: '已交至「{{name}}」，Leader 开始拆解任务…',
    recruiting_employee: '发现角色缺口「{{role}}」，将使用现有员工兜底规划…',
    plan_validating: '正在校验 Leader 方案是否可执行…',
    plan_revision_replanning: 'Leader 正在根据修改意见重新规划…',
    scheduled_leader_planning: '定时任务已触发，Leader 正在规划…',
