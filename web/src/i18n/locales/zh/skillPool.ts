...
const zh: TranslationTree = {
  skillPool: {
    ...
    assignModalAria: 'Skill 分配确认',
    assignModalDesc: '请选择要获得这个 Skill 的员工。导入或创建成功后默认选中所有员工：',
    loadingEmployees: '加载员工列表...',
    selectAll: '全选员工',
    unselectAll: '取消全选',
    selectedEmployees: '已选择 {{n}} / {{total}} 位员工',
    alreadyAssigned: '已拥有',
    selectAtLeastOne: '请至少选择一位员工',
    assignSelected: '分配给 {{n}} 位员工',
    assignBulkSuccess: '已分配给 {{n}} 位员工',
